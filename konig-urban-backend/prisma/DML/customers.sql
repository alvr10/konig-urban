...
SELECT u.id, x.nombre, x.apellidos, x.email, x.telefono, x.direccion, x.tipo_cliente, x.activo
FROM (
    VALUES
...
FROM (
    VALUES
    ('lucia.martin@konigurban.com',      'basico',      '2026-01-10', FALSE, TRUE),
    ('alejandro.ruiz@konigurban.com',    'white-glove', '2026-02-01', TRUE,  TRUE),
    ('carmen.navarro@konigurban.com',    'white-glove', '2026-03-15', TRUE,  TRUE),
    ('paula.jimenez@konigurban.com',     'basico',      '2026-03-20', TRUE,  TRUE)
