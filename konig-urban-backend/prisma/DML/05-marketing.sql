-- ============================================================
-- 05 · MARKETING SCHEMA — Seed Data
-- Dependencias: 01-catalog (colecciones), 04-customers (clientes)
-- ============================================================

-- Campañas vinculadas a colecciones (IDs resueltos dinámicamente)
...
JOIN catalog.colecciones c ON c.nombre = x.nombre_coleccion
ON CONFLICT DO NOTHING;

-- Campaña sin colección vinculada
INSERT INTO marketing.campanas
  (nombre, tipo, coleccion_id, fecha_inicio, fecha_fin, estado, descripcion)
VALUES
...
-- Clientes-campaña (IDs resueltos dinámicamente por nombre de campaña y email de cliente)
...
JOIN marketing.campanas   ca ON ca.nombre = x.nombre_campana
JOIN customers.clientes   cl ON cl.email  = x.email_cliente
